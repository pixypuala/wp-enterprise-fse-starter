...
|---|---|---|
| v0.1 | architecture spike and theme/plugin boundary | All milestone acceptance and audit gates |
| v0.2 | content model, dynamic blocks and migrations | All milestone acceptance and audit gates |
| v0.3 | Interactivity API and editor parity | All milestone acceptance and audit gates |
| v0.4 | complete test/evidence pipeline | All milestone acceptance and audit gates |
| v1.0 | stable extension points and migration policy | All milestone acceptance and audit gates |
